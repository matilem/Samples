...
{
    public class EditedRegistration
    {
        ...
        public virtual IList<EditedRegistrationBadge> Badges { get; set; }

        public virtual IList<EditedRegistrationSession> Sessions { get; set; }
    }
}