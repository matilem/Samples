...
namespace Aafp.Events.Web.Helpers
{
    public class SyndicationHelper
    {
        ...
        public static string GetSyndicatedSimpleHeader()
        {
            return GetHtml(ApplicationConfigManager.Settings.SyndicationSimpleHeaderUrl);
        }

        public static string GetSyndicatedSimpleFooter()
        {
            return GetHtml(ApplicationConfigManager.Settings.SyndicationSimpleFooterUrl);
        }
