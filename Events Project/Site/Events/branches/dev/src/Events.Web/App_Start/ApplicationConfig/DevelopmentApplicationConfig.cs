namespace Aafp.Events.Web.ApplicationConfig
{
    public class DevelopmentApplicationConfig : IApplicationConfig
    {
        ...
        public string SyndicationSimpleHeaderUrl => @"http://js.aafp.net/dev/simple/header.html";

        public string SyndicationSimpleFooterUrl => @"http://js.aafp.net/dev/simple/footer.html";
