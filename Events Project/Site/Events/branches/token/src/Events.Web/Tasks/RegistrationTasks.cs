    ...
    public class RegistrationTasks : IRegistrationTasks
    {
        ...
        public RegistrationIntroViewModel GetNewRegistrationIntroViewModel(string eventCode, string webLogin)
        {
            ...
            try
            {
                ...
                viewModel.Navigation = GetNavigation(Guid.Empty, viewModel.PendingSteps, 1);
        ...
        public RegistrationIntroViewModel GetRegistrationIntroViewModel(Guid registrationKey)
        {
            ...
            try
            {
                ...
                viewModel.Navigation = GetNavigation(registrationKey, viewModel.PendingSteps, 1);
        ...
        public RegistrationContactInfoViewModel GetRegistrationContactInfoViewModel(Guid registrationKey)
        {
            ...
            viewModel.Navigation = GetNavigation(registrationKey, viewModel.PendingSteps, 2);
        ...
        public RegistrationStepViewModel GetRegistrationStepViewModel(Guid registrationKey, Guid stepKey)
        {
            ...
            viewModel.Navigation = GetNavigation(registrationKey, viewModel.PendingSteps, currentProgress, viewModel.PendingEvents);
        ...
        public RegistrationConflictViewModel GetRegistrationAllowedConflictViewModel(Guid registrationKey)
        {
            ...
            viewModel.Navigation = GetNavigation(registrationKey, viewModel.PendingSteps, viewModel.PendingSteps.Count + 3, viewModel.PendingEvents);
        ...
        public RegistrationConfirmationViewModel GetRegistrationConfirmationViewModel(Guid registrationKey)
        {
            var viewModel = new RegistrationConfirmationViewModel();

            var result = HttpClientHelper.GetJson<RegistrationConfirmationViewModel>(eventService, $"registration/{registrationKey}/confirmation");
        ...
        private RegistrationNavigationViewModel GetNavigation(Guid registrationKey, List<EventStepViewModel> steps, int progress, Dictionary<Guid, EventViewModel> pendingEvents = null)
        {
