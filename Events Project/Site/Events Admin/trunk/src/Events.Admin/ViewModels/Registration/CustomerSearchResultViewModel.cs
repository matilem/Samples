...
namespace Aafp.Events.Admin.ViewModels.Registration
{
    public class CustomerSearchResultViewModel
    {
        ...
        public List<CustomerEventViewModel> Events { get; set; }
        ...
        public string AddressCityStateDisplay => $"{City}, {State}";

        public string NameDisplay => $"{LastName}, {FirstName} {MiddleName}";
