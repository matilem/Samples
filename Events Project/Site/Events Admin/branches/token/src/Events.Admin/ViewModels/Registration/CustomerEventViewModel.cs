    ...
    public class CustomerEventViewModel
    {
        ...
        public string EditLink
        {
            get
            {
                if (IsPending)
                {
                    return $"{ApplicationConfig.ApplicationConfigManager.Settings.ApplicationUrl}registration/pending/{RegistrationKey}";
                }
                else
                {
                    return $"{ApplicationConfig.ApplicationConfigManager.Settings.ApplicationUrl}registration/edit/{RegistrationKey}";
                }
            }
        }
    }
