...
namespace Aafp.Events.Admin.Tasks.Interfaces
{
    public interface IRegistrationTasks
    {
        ...
        EditedRegistrationViewModel SaveRegistration(RegistrationViewModel model);

        RegistrationViewModel GetRegistrationViewModel(Guid registrationKey);
        ...
        JsonResultViewModel<bool> RemovePendingRegistration(Guid pendingRegistrationKey);
    }
}